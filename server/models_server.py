    ...
    if local_deployment in ["full"]:
        other_pipes = {
            ...
            "espnet/kan-bayashi_ljspeech_vits": {
                "model": Text2Speech.from_pretrained(f"{local_fold}/espnet/kan-bayashi_ljspeech_vits/exp/tts_train_vits_raw_phn_tacotron_g2p_en_no_space/train.total_count.ave_10best.pth"),
                "device": device
            },
            # image-to-image
